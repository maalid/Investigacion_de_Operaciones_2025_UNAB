...
# Como la administración decidió permitir la separación de los productos (para que un producto sea 
...
# necesitará un destino ficticio de 75 para balancear lo antes mencionado .
...
# El objetivo del modelo es determinar el minimo costo total de trasporte, ademas de que satisfagan
# las restricciones de oferta y demanada.
...
# Valores óptimos para las variables de decisión. (Plan óptimo utilizando el modelo de transporte)

# Unidades producidas por la planta 1 por día que correspondenden al producto 2:

#		X12 = 30

# Unidades producidas por la planta 1 por día que correspondenden al producto 3:

#		X13 = 30

# Unidades producidas por la planta 1 por día que correspondenden al producto 5 (ficticio):

#		X15 = 15

# Unidades producidas por la planta 2 por día que correspondenden al producto 4:

#		X24 = 15

# Unidades producidas por la planta 2 por día que correspondenden al producto 5 (ficticio):

#		X25 = 60

# Unidades producidas por la planta 3 por día que correspondenden al producto 1:

#		X31 = 20

# Unidades producidas por la planta 3 por día que correspondenden al producto 4:

#		X34 = 25


# Costo mínimo asociado al plan de producción de los productos.

solucion_1

# solucion_1
# Success: the objective function is $ 3.260. 
# Nuestro plan óptimo de producción de productos para satisfacer las demandas de ventas proyectadas 
# es de $ 3.260 al día.
...
# Se debe evaluar tomar acciones futuras, como bajar la producción de la planta 1 en 15 productos y la producción de la planta 2
# en 60 productos diarios, ya que dicha producción de ambas plantas, está siendo requerida por el nodo ficticio eso quiere decir que no está siendo requerida 
# en estos momentos por las proyecciones de venta, por lo tanto, se deben tomar decisiones a futuro y evaluar si el 
# nodo ficticio destino es factible su implementación o no. 
