...
#Solucion
#Objective function (Maximum): 4325 
...
#conclusion
#Para poder optimizar la uilidad por venta de cajas de plastico la maquina M100 debera trabajar por 12.5 horas y la M200 por 10 horas, para obtener
#USD 4325 de utilidades. 
...
#2      4  >=    4    0 0.25
#Conclusion
#Se deben suministrar 0.50 kilos de maiz y 1.50 kilos de trigo para poder cumplir con la dieta diaria minima aconsejada por el veterinario, a menor costo
#posible.
...
#cvec - vector ???? de coeficientes c.
# bvec - vector ???? de valores b.
# Amat - matriz A de tamaño ???? × ????.
# maximum - especificar si se trata de maximización o minimización (pordefecto)
#const.dir- direccion de las desigualdades
